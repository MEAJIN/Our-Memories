...
- 모든 사용자를 포함하여 가장 최근에 등록 된 5개의 게시글 정보를 가져옴 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
...
- 모든 사용자를 포함하여 가장 최근에 등록 된 5개의 게시글 리스트가 나열 됨 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
- 리스트를 클릭하면 해당 게시글로 이동 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
...
- 'More▶' 버튼을 클릭하면 게시판으로 이동 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
  
  - 등록된 모든 게시글을 열람 가능 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
  - 게시글 작성 가능 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
...
- 찾고자 하는 컨텐츠의 키워드를 입력 시 관련 컨텐츠를 리스트로 출력. ([⭐추후 구현 예정](#⭐-추후-구현-기능))
...
- 로그인, 로그아웃, 비밀번호 찾기, 회원가입 기능을 제공 ([⭐추후 구현 예정](#⭐-추후-구현-기능))
